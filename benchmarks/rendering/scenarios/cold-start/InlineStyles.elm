...
viewHtml x =
    Html.div
        [ --Html.Attributes.class "se column spacing-20-20 content-top height-fill width-fill"
        ...
        (List.repeat x
            (Html.div
                [ --Html.Attributes.class "se el width-content height-content self-center-y self-center-x"
                  Html.Attributes.style
                    -- reset
                    [ ( "position", "relative" )
                    , ( "display", "flex" )
                ...
                [ Html.div
                    [ --Html.Attributes.class "se text width-fill"
                      Html.Attributes.style
                        -- reset
                        [ ( "position", "relative" )
                        , ( "display", "flex" )
